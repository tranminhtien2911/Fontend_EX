/**
 * 1. offsetWidth, offsetHaight, offsetLeft, offsetParent, offsetTop
 */
function log(value) {
    console.log(value);
}

let boxed = document.querySelector(".boxed");
...
log(boxed.offsetParent); //Để lấy phần tử cha để lấy giá trị của nó

/**
 * 2. clientWidth, clientheight, clientLeft, clientTop
 */

log(boxed.clientWidth); // Độ rộng của phần tử trừ đi border 2 bên
log(boxed.clientHeight); // Chiều cao của phần tử trừ đi border 2 bên
